...
- [ ] **צריך:** Push ל-remote (אם יש Netlify עם Continuous Deployment, זה יתחיל אוטומטית)
- [ ] **צריך:** Deploy הושלם בהצלחה

### שלב 2: בדיקה ידנית
לאחר ה-deploy, בדוק:

- [ ] **פתח בדפדפן:** `https://zukiapps.com/app-ads.txt`
- [ ] **צריך לראות:** `google.com, pub-5943094214429680, DIRECT, f08c47fec0942fa0`
- [ ] **Content-Type:** בדוק ב-DevTools שהתגובה כוללת `Content-Type: text/plain`
- [ ] **Status Code:** 200 OK
...
### 🔄 צריך לעשות:
1. **Push ל-remote** (אם לא כבר)
2. **Deploy** (אם יש Netlify, זה אוטומטי)
3. **בדוק ידנית:** `https://zukiapps.com/app-ads.txt`
4. **וודא הדומיין** ב-Google Play/App Store תואם
5. **המתן 24 שעות**
6. **בדוק ב-AdMob Console**
...
**✅ הכל מוכן! רק צריך deploy ולבדוק.**
