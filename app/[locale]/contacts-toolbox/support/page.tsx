...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'contactsToolbox.support' });
  ...
  return {
    ...
    robots: 'index, follow',
    alternates: {
      canonical: buildCanonical(locale, '/contacts-toolbox/support'),
      languages: buildLanguageAlternates('/contacts-toolbox/support'),
    },
  };
}
...
export default async function GeoCalcSupportPage({
  ...
  const t = await getTranslations({ locale, namespace: 'contactsToolbox.support' });
  const tHero = await getTranslations({ locale, namespace: 'contactsToolbox.hero' });
  ...
  return (
    <>
      <Script
        id="contacts-toolbox-support-faq-ld"
      ...
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('support'), path: '/contacts-toolbox/support' },
        ]}
      />
