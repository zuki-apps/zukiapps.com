...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'contactsToolbox.terms' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/contacts-toolbox/terms'),
      languages: buildLanguageAlternates('/contacts-toolbox/terms'),
    },
  };
}
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/contacts-toolbox/terms' },
        ]}
      />
          ...
          <div className="bg-violet-50 rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div className={rtl ? 'text-right' : 'text-left'}>
              ...
              <LegalSections
                ...
                contactExtraLinks={[
                  {
                    href: `/${locale}/contacts-toolbox/privacy`,
