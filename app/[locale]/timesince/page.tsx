    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: t('hero.productName'), path: '/timesince' },
        ]}
      />
      <div className="min-h-screen relative overflow-hidden">
        ...
        <section className={`py-12 px-4 relative z-10 ${rtl ? 'text-right' : 'text-center'}`} id="hero">
          <div className={`max-w-7xl mx-auto ${rtl ? '' : 'text-center'}`}>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-transparent">
              {t('hero.title')}
            </h1>
        ...
        <OtherZukiApps currentAppId="timesince" />
