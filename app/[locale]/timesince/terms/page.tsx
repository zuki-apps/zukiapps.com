...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'timeSince.terms' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/timesince/terms'),
      languages: buildLanguageAlternates('/timesince/terms'),
    },
  };
}

export default async function TimeSinceTermsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/timesince/terms' },
        ]}
      />
