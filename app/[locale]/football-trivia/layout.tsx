...
export default async function FootballTriviaLayout({
  children,
  params,
}: {
  ...
  return (
    <>
      <ProductStructuredDataBlock locale={locale} slug="football-trivia" />
      <AppClientMessages locale={locale} appFolder="football-trivia">{children}</AppClientMessages>
    </>
  );
}