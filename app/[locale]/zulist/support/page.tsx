      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-blue-50 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className={`${locale === 'he' || locale === 'ar' ? 'text-right' : 'text-left'}`}>
            ...
            {/* Contact Section */}
            <section className="bg-white rounded-lg p-6 mb-8 border-l-4 border-blue-600">
            ...
            <section className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <Link
                  href={`/${locale}/zulist/delete-account`}
                  className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow border border-gray-200"
                >
                  <div className="flex items-start gap-3">
                ...
                <Link
                  href={`/${locale}/zulist/delete-data`}
                  className="bg-white rounded-lg p-4 hover:shadow-lg transition-shadow border border-gray-200"
                >
                  <div className="flex items-start gap-3">
                    <Settings className="w-5 h-5 text-blue-600 flex-shrink-0 mt-1" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">
                        {t('quickLinks.deleteData.title')}
                      </h3>
                      <p className="text-sm text-gray-600">
                        {t('quickLinks.deleteData.description')}
                      </p>
                    </div>
                  </div>
                </Link>
