        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <AppIconFrame
              ...
              frameClassName="rounded-2xl overflow-hidden shadow-2xl ring-2 ring-blue-400/35 bg-gradient-to-br from-blue-950/90 via-slate-950 to-slate-950"
            />
          </div>
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-400 via-blue-300 to-blue-500 bg-clip-text text-transparent" style={{
