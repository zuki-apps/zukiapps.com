...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'geoCalc.terms' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/geo-calc/terms'),
      languages: buildLanguageAlternates('/geo-calc/terms'),
    },
  };
}
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/geo-calc/terms' },
        ]}
      />
