...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'geoCalc.support' });
  ...
  return {
    ...
    robots: 'index, follow',
    alternates: {
      canonical: buildCanonical(locale, '/geo-calc/support'),
      languages: buildLanguageAlternates('/geo-calc/support'),
    },
  };
}
...
export default async function GeoCalcSupportPage({
  ...
  const t = await getTranslations({ locale, namespace: 'geoCalc.support' });
  const tHero = await getTranslations({ locale, namespace: 'geoCalc.hero' });
    ...
    <>
      ...
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('support'), path: '/geo-calc/support' },
        ]}
      />
