...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'collagio.terms' });

  return {
    title: `${t('title')} — Collagio | Zuki Apps`,
    description:
      'Terms of Use for Collagio — photo collage app, Zuli Monsters intellectual property, Premium purchase, and acceptable use.',
    robots: { index: true, follow: true },
    alternates: {
      canonical: buildCanonical(locale, '/collagio/terms'),
      languages: buildLanguageAlternates('/collagio/terms'),
    },
  };
}

export default async function CollagioTermsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/collagio/terms' },
        ]}
      />
