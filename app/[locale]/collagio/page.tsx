    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: t('hero.title'), path: '/collagio' },
        ]}
      />
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 pt-4 flex items-center justify-between relative z-10">
          <Link
            href={`/${locale}`}
            className="inline-flex items-center gap-2 text-sky-400 hover:text-sky-300 font-black transition-colors"
          >
        ...
        <section className="py-16 px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <AppIconFrame
              src="/images/collagio-icon.png"
              alt={t('hero.title')}
              sizes="(max-width: 768px) 96px, 128px"
              priority
              className="mx-auto mb-8"
              boxClassName="w-24 h-24 md:w-32 md:h-32"
              frameClassName="rounded-2xl overflow-hidden shadow-2xl ring-2 ring-sky-400/40 bg-gradient-to-br from-sky-950/90 via-slate-950 to-slate-950"
            />
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-4 bg-gradient-to-r from-sky-400 via-blue-300 to-indigo-400 bg-clip-text text-transparent">
              {t('hero.title')}
            </h1>
            ...
            >
              ...
              <a
                href={`mailto:${supportEmail}?subject=Collagio%20Support`}
                className="inline-flex items-center gap-1.5 text-gray-400 hover:text-sky-400 transition-colors"
              >
