            ...
            <div className={rtl ? 'text-right' : 'text-left'}>
              ...
              <section className="bg-white rounded-lg p-6 mb-8 border-l-4 border-rose-600">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-rose-600 mb-3">{t('contact.title')}</h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <Shield className="w-5 h-5 text-rose-600 flex-shrink-0 mt-1" />
                      <div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <FileText className="w-5 h-5 text-rose-600 flex-shrink-0 mt-1" />
                      <div>
              ...
              <section className="bg-gray-100 p-6 rounded-lg border-l-4 border-rose-600 mt-8">
                <div className="flex items-start gap-3">
                  <MessageCircle className="w-6 h-6 text-rose-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-2xl font-bold text-rose-600 mb-3">{t('additionalHelp.title')}</h3>
