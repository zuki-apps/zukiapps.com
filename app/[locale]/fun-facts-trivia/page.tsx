...
import { ArrowLeft, Lightbulb, Timer, Trophy, Mail, ExternalLink, CheckCircle2 } from 'lucide-react';
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <section className="py-12 px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-amber-900/50 border border-amber-500/30 text-amber-200 px-4 py-2 rounded-full text-sm font-semibold mb-4 backdrop-blur-sm">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-8 shadow-lg hover:shadow-xl hover:border-amber-500/50 border-2 border-amber-600/30 transition-all backdrop-blur-sm bg-opacity-90">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">{t('features.gameplay.title')}</h3>
                <p className="text-gray-300 mb-4">{t('features.gameplay.description')}</p>
                <ul className="text-sm text-gray-400 space-y-2">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-8 shadow-lg hover:shadow-xl hover:border-amber-500/50 border-2 border-amber-600/30 transition-all backdrop-blur-sm bg-opacity-90 md:col-span-2 lg:col-span-1">
                <div className="bg-amber-600/30 w-16 h-16 rounded-full flex items-center justify-center mb-6 border border-amber-500/50">
                  <Trophy className="w-8 h-8 text-amber-400" />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-white">{t('features.progress.title')}</h3>
                <p className="text-gray-300 mb-4">{t('features.progress.description')}</p>
                <ul className="text-sm text-gray-400 space-y-2">
                  {t.raw('features.progress.items').map((item: string, i: number) => (
                    <li key={i}>• {item}</li>
                  ))}
                </ul>
              </div>
