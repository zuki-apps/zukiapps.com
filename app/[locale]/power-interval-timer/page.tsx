  ...
  return (
    <>
      <div className="min-h-screen relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center">
            <div className="mb-8">
              <AppIconFrame
                ...
                frameClassName="rounded-2xl overflow-hidden shadow-2xl ring-2 ring-orange-400/35 bg-gradient-to-br from-orange-950/90 via-slate-950 to-slate-950"
              />
            </div>
        ...
        <ProductMarketingSections namespace="powerIntervalTimer" slug="power-interval-timer" accent="orange" hasSupportPage={true} />
<section className="py-12 px-4 relative z-10">
