...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'blockiva.terms' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/blockiva/terms'),
      languages: buildLanguageAlternates('/blockiva/terms'),
    },
  };
}
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/blockiva/terms' },
        ]}
      />
