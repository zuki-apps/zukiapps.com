    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className={`py-12 px-4 relative z-10 ${rtl ? 'text-right' : 'text-center'}`} id="download">
        <div className={`max-w-7xl mx-auto ${rtl ? '' : 'text-center'}`}>
          ...
          <ProductPageNav namespace="blockiva" accent="amber" />
          ...
          <div className="flex justify-center gap-4 text-sm flex-wrap mb-4">
            <Link href={`/${locale}/blockiva/privacy`} className="text-amber-400 hover:text-amber-300 underline">
              {tCommon('privacyPolicy')}
            </Link>
            <span className="text-gray-500">|</span>
            <Link href={`/${locale}/blockiva/terms`} className="text-amber-400 hover:text-amber-300 underline">
              {tCommon('termsOfService')}
            </Link>
            <span className="text-gray-500">|</span>
            <Link href={`/${locale}/blockiva/support`} className="text-amber-400 hover:text-amber-300 underline">
              {tCommon('support')}
            </Link>
          </div>
        </div>
      ...
      <ProductMarketingSections namespace="blockiva" slug="blockiva" accent="amber" hasSupportPage showPromoMascot={false} />
      ...
      <footer className="twilight-footer-bar text-white py-8 px-4 mt-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 mt-4 text-sm flex-wrap">
            <Link href={`/${locale}/blockiva/support`} className="text-gray-400 hover:text-amber-400 transition-colors">
              {tCommon('support')}
            </Link>
            <span className="text-gray-500">|</span>
            <Link href={`/${locale}/blockiva/privacy`} className="text-gray-400 hover:text-amber-400 transition-colors">
              {tCommon('privacyPolicy')}
            </Link>
            <span className="text-gray-500">|</span>
            <Link href={`/${locale}/blockiva/terms`} className="text-gray-400 hover:text-amber-400 transition-colors">
              {tCommon('termsOfService')}
            </Link>
          </div>
        </div>
