...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'blockiva.privacy' });
  const tHero = await getTranslations({ locale, namespace: 'blockiva' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/blockiva/privacy'),
      languages: buildLanguageAlternates('/blockiva/privacy'),
    },
  };
}
...
export default async function GeoCalcPrivacyPage({
  ...
  const tApp = await getTranslations({ locale, namespace: 'blockiva.hero' });
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: brandName, path: '/blockiva' },
          { name: tCommon('privacyPolicy'), path: '/blockiva/privacy' },
        ]}
      />
