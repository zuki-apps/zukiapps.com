...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'blockiva.support' });
  ...
  return {
    ...
    robots: 'index, follow',
    alternates: {
      canonical: buildCanonical(locale, '/blockiva/support'),
      languages: buildLanguageAlternates('/blockiva/support'),
    },
  };
}
...
export default async function GeoCalcSupportPage({
  ...
  const t = await getTranslations({ locale, namespace: 'blockiva.support' });
  const tHero = await getTranslations({ locale, namespace: 'blockiva.hero' });
    ...
    <>
      ...
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('support'), path: '/blockiva/support' },
        ]}
      />
