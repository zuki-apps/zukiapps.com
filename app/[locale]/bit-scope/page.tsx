      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <section className="py-12 px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-cyan-400 via-cyan-300 to-cyan-500 bg-clip-text text-transparent" style={{
        ...
        <ProductMarketingSections namespace="bitScope" slug="bit-scope" accent="cyan" hasSupportPage={true} />
<section className="py-12 px-4 relative z-10">
