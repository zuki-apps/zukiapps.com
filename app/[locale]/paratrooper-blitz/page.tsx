      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <section className="py-12 px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1
              className="text-5xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-transparent"
              style={{
        ...
        <ProductMarketingSections namespace="paratrooperBlitz" slug="paratrooper-blitz" accent="green" hasSupportPage={true} />
<section className="py-12 px-4 relative z-10">
        ...
        <section className="py-12 px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-1 gap-6 max-w-xl mx-auto">
              <Link
                href={`/${locale}/paratrooper-blitz/support`}
                className={`bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl hover:border-orange-500/50 transition-all flex items-center gap-4 group border-2 border-orange-600/30 backdrop-blur-sm bg-opacity-90 ${locale === 'he' || locale === 'ar' ? 'flex-row-reverse' : ''}`}
              >
