...
export default function ZTLGuardPage() {
  const t = useTranslations('ztlGuard');
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className={`py-12 px-4 relative z-10 ${rtl ? 'text-right' : 'text-center'}`} id="download">
        <div className={`max-w-7xl mx-auto ${rtl ? '' : 'text-center'}`}>
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-orange-400 via-orange-300 to-orange-500 bg-clip-text text-transparent">
            {t('hero.title')}
          </h1>
          ...
          <ProductPageNav namespace="ztlGuard" accent="orange" />
          ...
          <div className="mb-10">
            <StoreDownloadBadges
              ...
              utmContent="ztl-guard"
            />
          </div>

          <div className="flex justify-center gap-4 text-sm flex-wrap mb-4">
            <Link href={`/${locale}/ztl-guard/privacy`} className="text-orange-400 hover:text-orange-300 underline">
              {tCommon('privacyPolicy')}
            </Link>
            <span className="text-gray-500">|</span>
            <Link href={`/${locale}/ztl-guard/terms`} className="text-orange-400 hover:text-orange-300 underline">
      ...
      <ProductMarketingSections namespace="ztlGuard" slug="ztl-guard" accent="orange" hasSupportPage showPromoMascot={false} />
      ...
      <footer className="twilight-footer-bar text-white py-8 px-4 mt-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 mt-4 text-sm flex-wrap">
            <Link href={`/${locale}/ztl-guard/support`} className="text-gray-400 hover:text-orange-400 transition-colors">
              {tCommon('support')}
            </Link>
            <span className="text-gray-500">|</span>
            <Link href={`/${locale}/ztl-guard/privacy`} className="text-gray-400 hover:text-orange-400 transition-colors">
              {tCommon('privacyPolicy')}
            </Link>
            <span className="text-gray-500">|</span>
