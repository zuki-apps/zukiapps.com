...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'ztlGuard.privacy' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/ztl-guard/privacy'),
      languages: buildLanguageAlternates('/ztl-guard/privacy'),
    },
  };
}
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('privacyPolicy'), path: '/ztl-guard/privacy' },
        ]}
      />
