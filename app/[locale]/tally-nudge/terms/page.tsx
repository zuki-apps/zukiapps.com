...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'tallyNudge.terms' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/tally-nudge/terms'),
      languages: buildLanguageAlternates('/tally-nudge/terms'),
    },
  };
}
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/tally-nudge/terms' },
        ]}
      />
