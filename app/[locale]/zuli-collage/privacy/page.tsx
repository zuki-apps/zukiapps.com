...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'zuliCollage.privacy' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/zuli-collage/privacy'),
      languages: buildLanguageAlternates('/zuli-collage/privacy'),
    },
  };
}

export default async function ZuliCollagePrivacyPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('privacyPolicy'), path: '/zuli-collage/privacy' },
        ]}
      />
