...
import { ImageIcon, ArrowLeft, Construction } from 'lucide-react';
...
export async function generateMetadata({
  ...
  routing.locales.forEach((loc) => {
    const altPrefix = loc === routing.defaultLocale && routing.localePrefix === 'as-needed'
      ? ''
      : `/${loc}`;
    alternatesLanguages[loc] = `${baseUrl}${altPrefix}/hush-gallery`;
  });

  return {
    title: 'Hush Gallery - Coming Soon | Zuki Apps',
    description: 'Hush Gallery is a secure and private photo gallery application that allows you to keep your personal photos safe and organized. Coming soon!',
    keywords: ['photo gallery', 'private photos', 'secure storage', 'photo organization', 'mobile app', 'privacy'],
    ...
    openGraph: {
      ...
      siteName: 'Zuki Apps',
      title: 'Hush Gallery - Coming Soon | Zuki Apps',
      description: 'Hush Gallery is a secure and private photo gallery application. Coming soon!',
      images: [
        {
          url: `${baseUrl}/logo.png`,
          width: 1200,
          height: 630,
          alt: 'Hush Gallery - Zuki Apps',
        },
      ],
    },
    twitter: {
...
export default async function HushGalleryPage({
  params
}: {
  params: Promise<{ locale: string }>;
}) {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="relative w-32 h-32 md:w-40 md:h-40">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl shadow-2xl flex items-center justify-center">
            ...
            <p className="text-xl md:text-2xl font-semibold text-gray-300 mb-8">
              {t('hushGallery.subtitle')}
            </p>

            {/* Under Construction Message */}
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl p-8 md:p-12 mb-8 border-2 border-purple-600/30 hover:border-purple-500/50 hover:shadow-3xl transition-all duration-300 backdrop-blur-sm bg-opacity-90">
              <div className="flex items-center justify-center mb-6">
                <Construction className="w-16 h-16 text-purple-400" aria-hidden="true" />
              </div>
