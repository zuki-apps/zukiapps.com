...
export async function generateMetadata({
  ...
  return {
    title: 'Support - Hush Gallery | Zuki Apps',
    description: 'Get help and support for Hush Gallery. Find answers to common questions, contact information, and helpful resources.',
    robots: 'index, follow',
    alternates: {
      canonical: locale === routing.defaultLocale && routing.localePrefix === 'as-needed' 
        ? `${baseUrl}/hush-gallery/support` 
        : `${baseUrl}/${locale}/hush-gallery/support`,
      languages: Object.fromEntries(
        routing.locales.map((loc) => [
          loc,
          loc === routing.defaultLocale && routing.localePrefix === 'as-needed' 
            ? `${baseUrl}/hush-gallery/support` 
            : `${baseUrl}/${loc}/hush-gallery/support`
        ])
      )
    }
  };
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">
                        {t('quickLinks.deleteAccount.title')}
                      </h3>
                      <p className="text-sm text-gray-600">
                        {t('quickLinks.deleteAccount.description')}
                      </p>
                    </div>
                  </div>
                </Link>
