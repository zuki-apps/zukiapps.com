...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'questivo.terms' });
  ...
  return {
    ...
    alternates: {
      canonical: buildCanonical(locale, '/questivo/terms'),
      languages: buildLanguageAlternates('/questivo/terms'),
    },
  };
}
    ...
    <>
      <BreadcrumbsStructuredData
        ...
        items={[
          ...
          { name: tCommon('termsOfService'), path: '/questivo/terms' },
        ]}
      />
