...
const routes: SitemapRouteMeta[] = [
  ...
  { path: '/tempoLabPro', priority: 0.9, changefreq: 'weekly' },
  { path: '/tempoLabPro/privacy', priority: 0.5, changefreq: 'monthly' },
  { path: '/tempoLabPro/terms', priority: 0.5, changefreq: 'monthly' },
  { path: '/tempoLabPro/support', priority: 0.7, changefreq: 'monthly' },
