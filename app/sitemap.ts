...
const routes: SitemapRouteMeta[] = [
  ...
  ...(ZULI_COLLAGE_PUBLISHED || ZULI_COLLAGE_PILOT
    ...
    : []),
  ...(TIMESINCE_PUBLISHED || TIMESINCE_PILOT
    ? [
        { path: '/timesince', priority: 0.9, changefreq: 'weekly' } satisfies SitemapRouteMeta,
        { path: '/timesince/support', priority: 0.7, changefreq: 'monthly' } satisfies SitemapRouteMeta,
    ...
    : TIMESINCE_UNDER_CONSTRUCTION
      ? [
          { path: '/timesince', priority: 0.55, changefreq: 'monthly' } satisfies SitemapRouteMeta,
          { path: '/timesince/privacy', priority: 0.5, changefreq: 'monthly' } satisfies SitemapRouteMeta,
          { path: '/timesince/terms', priority: 0.5, changefreq: 'monthly' } satisfies SitemapRouteMeta,
  ...
  ...(COLORING_MY_PHOTO_PUBLISHED || COLORING_MY_PHOTO_PILOT
    ...
    : COLORING_MY_PHOTO_UNDER_CONSTRUCTION
      ...
      : []),
  ...(PHOTO_STAMP_PUBLISHED || PHOTO_STAMP_PILOT
    ? [
        { path: '/photo-stamp', priority: 0.9, changefreq: 'weekly' } satisfies SitemapRouteMeta,
        { path: '/photo-stamp/support', priority: 0.7, changefreq: 'monthly' } satisfies SitemapRouteMeta,
    ...
    : PHOTO_STAMP_UNDER_CONSTRUCTION
      ? [
          { path: '/photo-stamp', priority: 0.55, changefreq: 'monthly' } satisfies SitemapRouteMeta,
          { path: '/photo-stamp/privacy', priority: 0.5, changefreq: 'monthly' } satisfies SitemapRouteMeta,
          { path: '/photo-stamp/terms', priority: 0.5, changefreq: 'monthly' } satisfies SitemapRouteMeta,
