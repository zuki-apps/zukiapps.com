...
export default function AppsCarousel() {
  ...
  const appsById = useMemo(
    ...
    eventtick: {
      id: 'eventtick',
      icon: <CalendarClock className="w-16 h-16 text-sky-400" aria-hidden="true" />,
      iconImage: HOME_APP_ICON_WEBP.eventtick,
      iconEdgeToEdge: true,
      titleKey: 'eventTick.title',
      subtitleKey: 'eventTick.subtitle',
      descriptionKey: 'eventTick.description',
      featuresKey: 'eventTick.features',
      learnMoreKey: 'eventTick.learnMore',
      link: `/${locale}/eventtick`,
      isComingSoon: false,
    },
    'tally-nudge': {
      id: 'tally-nudge',
      icon: <Hash className="w-16 h-16 text-emerald-400" aria-hidden="true" />,
      iconImage: HOME_APP_ICON_WEBP['tally-nudge'],
      iconEdgeToEdge: true,
      titleKey: 'tallyNudge.title',
      subtitleKey: 'tallyNudge.subtitle',
      descriptionKey: 'tallyNudge.description',
      featuresKey: 'tallyNudge.features',
      learnMoreKey: 'tallyNudge.learnMore',
      link: `/${locale}/tally-nudge`,
      isComingSoon: false,
    },
    blockiva: {
      id: 'blockiva',
      icon: <Puzzle className="w-16 h-16 text-amber-400" aria-hidden="true" />,
      iconImage: HOME_APP_ICON_WEBP.blockiva,
      iconEdgeToEdge: true,
      titleKey: 'blockiva.title',
      subtitleKey: 'blockiva.subtitle',
      descriptionKey: 'blockiva.description',
      featuresKey: 'blockiva.features',
      learnMoreKey: 'blockiva.learnMore',
